...
insert into purchase (prod_id, user_id, place) values (1, 3, '롯데백화점');
insert into purchase (prod_id, user_id, place) values (1, 4, '현대백화점');
...
insert into purchase (prod_id, user_id, place) values (2, 4, '전자랜드');
insert into purchase (prod_id, user_id, place) values (3, 5, '문방구');
insert into purchase (prod_id, user_id, place) values (4, 1, 'G 마켓');
insert into purchase (prod_id, user_id, place) values (4, 2, '쿠팡');
insert into purchase (prod_id, user_id, place) values (4, 5, '쿠팡');
